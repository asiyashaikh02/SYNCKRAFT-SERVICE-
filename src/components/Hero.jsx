    ...
    <section className="relative min-h-[707px] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button className="w-full sm:w-auto px-8 py-4 bg-primary text-on-primary rounded-xl font-bold text-lg hover:shadow-[0_0_20px_rgba(137,206,255,0.4)] transition-all">
            Launch Systems
          </button>
          <button className="w-full sm:w-auto px-8 py-4 bg-surface-container-high text-on-surface rounded-xl font-bold text-lg border border-outline-variant/20 hover:bg-surface-container-highest transition-all">
            View Solutions
          </button>
        </div>
      </div>
