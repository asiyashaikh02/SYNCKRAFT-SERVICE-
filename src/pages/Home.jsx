        ...
        <section className="py-24 px-6 bg-surface-container-lowest">
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              <IndustryCard to="/healthcare" icon="medical_services" colorClass="text-tertiary" title="Healthcare" description="Data-driven diagnostics & ops." />
              <IndustryCard to="/fashion" icon="apparel" colorClass="text-secondary" title="Fashion" description="Trend forecasting & logistics." />
              <IndustryCard to="/beauty" icon="auto_awesome" colorClass="text-primary" title="Beauty" description="Personalized curation AI." />
              <IndustryCard to="/jewelry" icon="diamond" colorClass="text-tertiary" title="Jewellery" description="Inventory tracking & luxury CRM." />
              <IndustryCard to="/supermarket" icon="shopping_cart" colorClass="text-secondary" title="Supermarkets" description="Supply chain automation." />
              <IndustryCard to="/furniture" icon="chair" colorClass="text-primary" title="Furniture" description="AR-integrated retail systems." />
              <IndustryCard to="/gym" icon="fitness_center" colorClass="text-tertiary" title="Gym" description="Member retention algorithms." />
              <IndustryCard to="/retail" icon="storefront" colorClass="text-secondary" title="Retail" description="Intelligent retail analytics." />
              <IndustryCard to="/obsidian" icon="robot_2" colorClass="text-primary" title="AI / Obsidian" description="Core system transformations." highlightClass="bg-primary/5 border border-primary/20 hover:bg-primary/10" />
            </div>
          </div>
        </section>
